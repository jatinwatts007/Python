...
f2 = Frame(root,width=300, height=700,bg="light yellow", relief=SUNKEN)
f2.pack(side=RIGHT)
...
lblInfo=Label(Tops,font=('arial',50,'bold'),text="CHIRAG RESTAURANT ",fg="Steel Blue",bd=10,anchor='w')
